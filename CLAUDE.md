...
└── docs/                   # Plans and institutional learnings
```
...
Detailed technical context (versions, design tokens, content model) is in `.claude/project_context.md`. Load it when you need specifics beyond what's here.
